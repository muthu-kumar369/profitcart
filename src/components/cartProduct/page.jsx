    ...
    return (
        <>
            <section className="search-product px-10 xl:px-32">
                <div className='cart-div border border-lime-600 rounded mt-5 pt-3'>
                    <p className="title tex-lg font-bold md:text-xl text-lime-800 capitalize py-2 pl-5">Cart items</p>
                    <div>
                                        ...
                                        <div className="card lg:grid lg:grid-cols-12 my-4 mx-5">
                                            ...
                                            <div className="card-details lg:col-span-8 p-4 `">
                                                ...
                                                <div className="footer xl:flex py-3">
                                                    <div className="count-div w-min flex items-center left-1/2 border border-lime-800 mx-5">
                                                        <button className='px-2 border-r border-lime-800 text-4xl' onClick={(e) => handleQuantityUpdate(item, "reduce", e)} disabled={item?.quantity <= 1 ? true : false}>-</button>
                                                        <p className='py-1 px-3 font-bold border-r border-lime-800 text-xl'>{item?.quantity}</p>
                        ...
                        }) : <div className='no-details flex items-center justify-center'>
                ...
                <div className='cart-div border border-lime-600 rounded mt-5 py-3 pb-10'>
                    <p className="title text-lg font-bold md:text-xl text-lime-800 capitalize ml-5">Buy later items</p>
                    <div>
            ...
            <div className='w-full fixed bottom-0 p-3 py-5 border border-lime-800 bg-white'>
                <div className='flex items-center justify-center'>
                    <p className="total mx-5 text-xl text-lime-800 font-extrabold">Total: </p>
                    <div className="price-details text-center">
                        <p className="price text-lime-800 text-xl font-bold">&#8377; {data?.cart?.data[0]?.totalAmount > 0 ? data?.cart?.data[0]?.totalAmount : "---   "}</p>
                        <p className=' line-through text-sm text-lime-800 font-medium'>&#8377; {data?.cart?.data[0]?.totalActualAmount > 0 ? data?.cart?.data[0]?.totalActualAmount : "---"}</p>
                    </div>
                    <div className='mx-5'> 
                    ...
                    <div className="btn-div buy-now mx-5 px-6 py-2 cursor-pointer">
                        <Link href={'cart/purchase'} className=''>Buy now</Link>
                    </div>
                </div>
            </div>
        </>
